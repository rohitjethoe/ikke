    ...
    <Layout>
        ...
        <div>
          <div class="pt-36">
            ...
            <div class="pt-12 pb-24">
              <p class="font-cormorant w-5/6 mx-auto text-right text-base sm:text-lg">Bol.com Affiliate Web API is een backendsysteem gebouwd in Node.js die gebruik maakt van caching om de JWT tokens op te slaan. Zo worden er aan de regels voldaan van Bol.com om zo min mogelijk API calls te maken.</p>
              <div class="flex mt-8 w-[200vw]">
                ...
                <div class="w-[366px]">
                  <img class="-translate-x-36 -translate-y-2 aspect-video object-contain" src="@/assets/bol-web-api.webp" alt="">
                </div>
                <div class="w-[100px] -translate-x-[520px] -translate-y-4">
                  <img class="rounded" src="@/assets/bol.webp" alt="">
                </div>
              </div>
              <div class="text-center text-sm sm:text-base mt-12">
          ...
          <div class="pt-36">
            ...
            <div class="pt-12">
              ...
              <div class="flex items-center gap-6">
                <img class="w-36" src="@/assets/monostatic.webp" alt="">
                <div class="text-sm">
